...
.teachers {
  ...
  font-weight: bold;
  background-image: url("../assets/m7.jpg");
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;
}
.table {
  background-image: url("https://cdn.discordapp.com/attachments/788074443574214696/799248597693759508/table2.jpg");
}
.bar {
  padding-bottom: 30px;
}
